...
router.post('/', function(req, res, next) {
  ...
  try {
    (async () => {
      ...
      var escapedText = querystring.escape(req.body.text);
      const uri = `https://translate.google.com/#view=home&op=translate&sl=${querySourceLang}&tl=${req.body.lang}&text=${escapedText}`;
